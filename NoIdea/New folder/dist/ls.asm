...
fmtname(char *path)
{
 ...
 2e2:	68 64 12 00 00       	push   $0x1264
 ...
 314:	05 64 12 00 00       	add    $0x1264,%eax
 ...
 325:	83 c4 10             	add    $0x10,%esp
  return buf;
 328:	b8 64 12 00 00       	mov    $0x1264,%eax
}
...
ls(char *path)
{
 ...
 369:	83 c4 10             	add    $0x10,%esp
    return;
 36c:	e9 45 02 00 00       	jmp    5b6 <ls+0x284>
  }
 ...
 3aa:	83 c4 10             	add    $0x10,%esp
    return;
 3ad:	e9 04 02 00 00       	jmp    5b6 <ls+0x284>
  }

#ifdef CS333_P5
  printf(1, "\nMode\t\t Name\t\t UID\t GID\t inode\t Size\n"); 
 3b2:	83 ec 08             	sub    $0x8,%esp
 3b5:	68 14 0f 00 00       	push   $0xf14
 3ba:	6a 01                	push   $0x1
 3bc:	e8 62 07 00 00       	call   b23 <printf>
 3c1:	83 c4 10             	add    $0x10,%esp
#endif

  switch(st.type){
 3c4:	0f b7 85 b4 fd ff ff 	movzwl -0x24c(%ebp),%eax
 3cb:	98                   	cwtl   
 3cc:	83 f8 01             	cmp    $0x1,%eax
 3cf:	74 70                	je     441 <ls+0x10f>
 3d1:	83 f8 02             	cmp    $0x2,%eax
 3d4:	0f 85 ce 01 00 00    	jne    5a8 <ls+0x276>
  case T_FILE:
#ifdef CS333_P5
    print_mode(&st);
 3da:	83 ec 0c             	sub    $0xc,%esp
 3dd:	8d 85 b4 fd ff ff    	lea    -0x24c(%ebp),%eax
 3e3:	50                   	push   %eax
 3e4:	e8 17 fc ff ff       	call   0 <print_mode>
 3e9:	83 c4 10             	add    $0x10,%esp
    printf(1, "\t%s\t %d\t %d\t %d\t %d\t\n ", fmtname(path), st.uid, st.gid, st.ino, st.size);
 3ec:	8b 85 c4 fd ff ff    	mov    -0x23c(%ebp),%eax
 3f2:	89 85 a4 fd ff ff    	mov    %eax,-0x25c(%ebp)
 3f8:	8b bd bc fd ff ff    	mov    -0x244(%ebp),%edi
 3fe:	0f b7 85 ca fd ff ff 	movzwl -0x236(%ebp),%eax
 405:	0f b7 f0             	movzwl %ax,%esi
 408:	0f b7 85 c8 fd ff ff 	movzwl -0x238(%ebp),%eax
 40f:	0f b7 d8             	movzwl %ax,%ebx
 412:	83 ec 0c             	sub    $0xc,%esp
 415:	ff 75 08             	pushl  0x8(%ebp)
 418:	e8 5d fe ff ff       	call   27a <fmtname>
 41d:	83 c4 10             	add    $0x10,%esp
 420:	83 ec 04             	sub    $0x4,%esp
 423:	ff b5 a4 fd ff ff    	pushl  -0x25c(%ebp)
 429:	57                   	push   %edi
 42a:	56                   	push   %esi
 42b:	53                   	push   %ebx
 42c:	50                   	push   %eax
 42d:	68 3a 0f 00 00       	push   $0xf3a
 432:	6a 01                	push   $0x1
 434:	e8 ea 06 00 00       	call   b23 <printf>
 439:	83 c4 20             	add    $0x20,%esp
#else
    printf(1, "%s %d %d %d\n", fmtname(path), st.type, st.ino, st.size);
#endif
    break;
 43c:	e9 67 01 00 00       	jmp    5a8 <ls+0x276>
  
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
 441:	83 ec 0c             	sub    $0xc,%esp
 444:	ff 75 08             	pushl  0x8(%ebp)
 447:	e8 6b 02 00 00       	call   6b7 <strlen>
 44c:	83 c4 10             	add    $0x10,%esp
 44f:	83 c0 10             	add    $0x10,%eax
 452:	3d 00 02 00 00       	cmp    $0x200,%eax
 457:	76 17                	jbe    470 <ls+0x13e>
      printf(1, "ls: path too long\n");
 459:	83 ec 08             	sub    $0x8,%esp
 45c:	68 51 0f 00 00       	push   $0xf51
 461:	6a 01                	push   $0x1
 463:	e8 bb 06 00 00       	call   b23 <printf>
 468:	83 c4 10             	add    $0x10,%esp
      break;
 46b:	e9 38 01 00 00       	jmp    5a8 <ls+0x276>
    }
    strcpy(buf, path);
 ...
 47c:	50                   	push   %eax
 47d:	e8 c6 01 00 00       	call   648 <strcpy>
 482:	83 c4 10             	add    $0x10,%esp
    p = buf+strlen(buf);
 485:	83 ec 0c             	sub    $0xc,%esp
 488:	8d 85 e0 fd ff ff    	lea    -0x220(%ebp),%eax
 48e:	50                   	push   %eax
 48f:	e8 23 02 00 00       	call   6b7 <strlen>
 494:	83 c4 10             	add    $0x10,%esp
 497:	89 c2                	mov    %eax,%edx
 499:	8d 85 e0 fd ff ff    	lea    -0x220(%ebp),%eax
 49f:	01 d0                	add    %edx,%eax
 4a1:	89 45 e0             	mov    %eax,-0x20(%ebp)
    *p++ = '/';
 4a4:	8b 45 e0             	mov    -0x20(%ebp),%eax
 4a7:	8d 50 01             	lea    0x1(%eax),%edx
 4aa:	89 55 e0             	mov    %edx,-0x20(%ebp)
 4ad:	c6 00 2f             	movb   $0x2f,(%eax)
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 4b0:	e9 d2 00 00 00       	jmp    587 <ls+0x255>
      if(de.inum == 0)
 4b5:	0f b7 85 d0 fd ff ff 	movzwl -0x230(%ebp),%eax
 4bc:	66 85 c0             	test   %ax,%ax
 4bf:	75 05                	jne    4c6 <ls+0x194>
        continue;
 4c1:	e9 c1 00 00 00       	jmp    587 <ls+0x255>
      memmove(p, de.name, DIRSIZ);
 4c6:	83 ec 04             	sub    $0x4,%esp
 4c9:	6a 0e                	push   $0xe
 4cb:	8d 85 d0 fd ff ff    	lea    -0x230(%ebp),%eax
 4d1:	83 c0 02             	add    $0x2,%eax
 4d4:	50                   	push   %eax
 4d5:	ff 75 e0             	pushl  -0x20(%ebp)
 4d8:	e8 2a 04 00 00       	call   907 <memmove>
 4dd:	83 c4 10             	add    $0x10,%esp
      p[DIRSIZ] = 0;
 4e0:	8b 45 e0             	mov    -0x20(%ebp),%eax
 4e3:	83 c0 0e             	add    $0xe,%eax
 4e6:	c6 00 00             	movb   $0x0,(%eax)
      if(stat(buf, &st) < 0){
 4e9:	83 ec 08             	sub    $0x8,%esp
 4ec:	8d 85 b4 fd ff ff    	lea    -0x24c(%ebp),%eax
 4f2:	50                   	push   %eax
 4f3:	8d 85 e0 fd ff ff    	lea    -0x220(%ebp),%eax
 4f9:	50                   	push   %eax
 4fa:	e8 9b 02 00 00       	call   79a <stat>
 4ff:	83 c4 10             	add    $0x10,%esp
 502:	85 c0                	test   %eax,%eax
 504:	79 1b                	jns    521 <ls+0x1ef>
        printf(1, "ls: cannot stat %s\n", buf);
 506:	83 ec 04             	sub    $0x4,%esp
 509:	8d 85 e0 fd ff ff    	lea    -0x220(%ebp),%eax
 50f:	50                   	push   %eax
 510:	68 00 0f 00 00       	push   $0xf00
 515:	6a 01                	push   $0x1
 517:	e8 07 06 00 00       	call   b23 <printf>
 51c:	83 c4 10             	add    $0x10,%esp
        continue;
 51f:	eb 66                	jmp    587 <ls+0x255>
      }
#ifdef CS333_P5
      print_mode(&st);
 521:	83 ec 0c             	sub    $0xc,%esp
 524:	8d 85 b4 fd ff ff    	lea    -0x24c(%ebp),%eax
 52a:	50                   	push   %eax
 52b:	e8 d0 fa ff ff       	call   0 <print_mode>
 530:	83 c4 10             	add    $0x10,%esp
      printf(1, "\t%s\t %d\t %d\t %d\t %d\t\n ", fmtname(buf), st.uid, st.gid, st.ino, st.size);
 533:	8b 85 c4 fd ff ff    	mov    -0x23c(%ebp),%eax
 539:	89 85 a4 fd ff ff    	mov    %eax,-0x25c(%ebp)
 53f:	8b bd bc fd ff ff    	mov    -0x244(%ebp),%edi
 545:	0f b7 85 ca fd ff ff 	movzwl -0x236(%ebp),%eax
 54c:	0f b7 f0             	movzwl %ax,%esi
 54f:	0f b7 85 c8 fd ff ff 	movzwl -0x238(%ebp),%eax
 556:	0f b7 d8             	movzwl %ax,%ebx
 559:	83 ec 0c             	sub    $0xc,%esp
 55c:	8d 85 e0 fd ff ff    	lea    -0x220(%ebp),%eax
 562:	50                   	push   %eax
 563:	e8 12 fd ff ff       	call   27a <fmtname>
 568:	83 c4 10             	add    $0x10,%esp
 56b:	83 ec 04             	sub    $0x4,%esp
 56e:	ff b5 a4 fd ff ff    	pushl  -0x25c(%ebp)
 574:	57                   	push   %edi
 575:	56                   	push   %esi
 576:	53                   	push   %ebx
 577:	50                   	push   %eax
 578:	68 3a 0f 00 00       	push   $0xf3a
 57d:	6a 01                	push   $0x1
 57f:	e8 9f 05 00 00       	call   b23 <printf>
 584:	83 c4 20             	add    $0x20,%esp
      break;
    }
    strcpy(buf, path);
    p = buf+strlen(buf);
 ...
 58a:	6a 10                	push   $0x10
 58c:	8d 85 d0 fd ff ff    	lea    -0x230(%ebp),%eax
 592:	50                   	push   %eax
 593:	ff 75 e4             	pushl  -0x1c(%ebp)
 596:	e8 c9 03 00 00       	call   964 <read>
 59b:	83 c4 10             	add    $0x10,%esp
 59e:	83 f8 10             	cmp    $0x10,%eax
 5a1:	0f 84 0e ff ff ff    	je     4b5 <ls+0x183>
      printf(1, "\t%s\t %d\t %d\t %d\t %d\t\n ", fmtname(buf), st.uid, st.gid, st.ino, st.size);
#else
 ...
 5ab:	ff 75 e4             	pushl  -0x1c(%ebp)
 5ae:	e8 c1 03 00 00       	call   974 <close>
...
{
 5be:	8d 4c 24 04          	lea    0x4(%esp),%ecx
 5c2:	83 e4 f0             	and    $0xfffffff0,%esp
 5c5:	ff 71 fc             	pushl  -0x4(%ecx)
 5c8:	55                   	push   %ebp
 ...
 5d5:	7f 15                	jg     5ec <main+0x2e>
    ls(".");
 5d7:	83 ec 0c             	sub    $0xc,%esp
 5da:	68 64 0f 00 00       	push   $0xf64
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 abf:	0f b6 80 50 12 00 00 	movzbl 0x1250(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 bfb:	75 25                	jne    c22 <printf+0xff>
          s = "(null)";
 bfd:	c7 45 f4 66 0f 00 00 	movl   $0xf66,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 cc3:	a1 7c 12 00 00       	mov    0x127c,%eax
...
free(void *ap)
{
 ...
 d8e:	a3 7c 12 00 00       	mov    %eax,0x127c
}
 d93:	90                   	nop
 d94:	c9                   	leave  
 d95:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 dec:	83 c4 10             	add    $0x10,%esp
  return freep;
 def:	a1 7c 12 00 00       	mov    0x127c,%eax
}
 df4:	c9                   	leave  
 df5:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 e08:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 e0b:	a1 7c 12 00 00       	mov    0x127c,%eax
 e10:	89 45 f0             	mov    %eax,-0x10(%ebp)
 e13:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 e17:	75 23                	jne    e3c <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 e19:	c7 45 f0 74 12 00 00 	movl   $0x1274,-0x10(%ebp)
 e20:	8b 45 f0             	mov    -0x10(%ebp),%eax
 e23:	a3 7c 12 00 00       	mov    %eax,0x127c
 e28:	a1 7c 12 00 00       	mov    0x127c,%eax
 e2d:	a3 74 12 00 00       	mov    %eax,0x1274
    base.s.size = 0;
 e32:	c7 05 78 12 00 00 00 	movl   $0x0,0x1278
 e39:	00 00 00 
  }
 ...
 e8f:	a3 7c 12 00 00       	mov    %eax,0x127c
      return (void*)(p + 1);
 ...
 e9a:	eb 3b                	jmp    ed7 <malloc+0xe1>
    ...
    if(p == freep)
 e9c:	a1 7c 12 00 00       	mov    0x127c,%eax
